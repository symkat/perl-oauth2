...
documents no less than 5 I<flow>s at
L<https://developers.google.com/accounts/docs/OAuth2>, none of which have
been given the above names.  (They offer a new one, rename the top two, and
split I<native application> into two different I<flow>s based on whether or
not your application controls a usable web browser.)
...
L<http://tools.ietf.org/html/rfc6750|RFV 6750>.  For as long as the token is
